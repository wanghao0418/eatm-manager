 ...
 * @LastEditTime: 2023-07-25 11:36:55
      ...
      Positioned(
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color:
                    isHover ? GlobalTheme.instance.accentColor : Colors.white,
              ...
              child: InkWell(
                ...
                child: Icon(
                  ...
                  size: 10,
                  color:
                      isHover ? Colors.white : GlobalTheme.instance.accentColor,
                ),
  ...
  Widget _buildNavigationMenuItem(MenuItem menu) {
    ...
    if (menu.children != null && menu.children!.isNotEmpty) {
      return ExpansionTile(
        ...
        childrenPadding: EdgeInsets.only(
            left: expandMenu ? 20 : 0, right: expandMenu ? 20 : 0),
        children:
    ...
    return Tooltip(
      ...
      child: ListTile(
        ...
        leading: Icon(MainChildPages.getIcon(menu.url!),
